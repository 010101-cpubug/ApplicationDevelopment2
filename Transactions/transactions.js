...
async function loadTransactionsFromDB() {
    try {
        ...
        if (transactionsState.userProfile) {
            ...
            transactionsState.currencySymbol = appwriteService.getCurrencySymbol(transactionsState.currency);
...
function formatCurrency(amount, withSymbol = true) {
    return appwriteService.formatCurrency(amount, transactionsState.currency, withSymbol);
}
